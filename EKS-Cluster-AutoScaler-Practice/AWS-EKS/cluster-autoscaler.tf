...
#             Condition = {
#                 "StringEquals" = {
#                     "${aws_iam_openid_connect_provider.eks-oidc.url}:sub" = "system:serviceaccount:kube-system:cluster-autoscaler", #system:serviceaccount:<namespace>:<service-account-name>
...
#         container {
#           name  = "cluster-autoscaler"
#           image = "registry.k8s.io/autoscaling/cluster-autoscaler:${var.cluster_version}"
#           command  = [
#             "./cluster-autoscaler",
#             "--v=4",
